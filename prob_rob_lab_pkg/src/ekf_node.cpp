...
public:
  EKFNode() : Node("ekf_node")
  {
    ...
    RCLCPP_INFO(this->get_logger(), "[EKF] Motion model: %s",
    ...
    pub_pose_ = this->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("/ekf/pose", 10);
    ...
    sub_cmd_  = this->create_subscription<geometry_msgs::msg::Twist>("/cmd_vel_unstamped", 10,
      std::bind(&EKFNode::cmd_callback, this, std::placeholders::_1));
